...
const Chat = ({ room, setRoom }) => {
  ...
  // kolleksiyonun refaransını alma
  ...
  useEffect(()=>{
    ...
    // kolleksiyon her değiştiğinde bir fonksiyon çalıştırır
    ...
    const unsubscribe = onSnapshot(queryOptions, (snapshot)=>{
      ...
      // dökümanları dönüp doc içerisindeki verilere erişip bir diziye aktarma
